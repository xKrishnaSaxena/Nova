...
import MintTokenForm from "../../components/tokenERC/ERC20MintTokenForm";

const MintTokenPageERC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] to-[#141414] flex items-center text-white justify-center p-4">
      ...
      >
        <motion.img
          src="/Eth.png"
          className="w-full h-full mt-12 text-green-500/20"
        />
      </motion.div>
...
export default MintTokenPageERC;
